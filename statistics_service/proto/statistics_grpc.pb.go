...
const (
	StatisticsService_GetUserOrderStats_FullMethodName = "/statistics.StatisticsService/GetUserOrderStats"
)
...
type StatisticsServiceClient interface {
	GetUserOrderStats(ctx context.Context, in *UserStatsRequest, opts ...grpc.CallOption) (*UserStatsResponse, error)
}
...
func (c *statisticsServiceClient) GetUserOrderStats(ctx context.Context, in *UserStatsRequest, opts ...grpc.CallOption) (*UserStatsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserStatsResponse)
	err := c.cc.Invoke(ctx, StatisticsService_GetUserOrderStats_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StatisticsServiceServer interface {
	GetUserOrderStats(context.Context, *UserStatsRequest) (*UserStatsResponse, error)
...
func (UnimplementedStatisticsServiceServer) GetUserOrderStats(context.Context, *UserStatsRequest) (*UserStatsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserOrderStats not implemented")
}
...
func _StatisticsService_GetUserOrderStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserStatsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatisticsServiceServer).GetUserOrderStats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StatisticsService_GetUserOrderStats_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatisticsServiceServer).GetUserOrderStats(ctx, req.(*UserStatsRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _StatisticsService_GetUserOrderStats_Handler,
		},
	},
